...
const Skills = (props: Props) => {
  return (
    <motion.div className="flex relative flex-col text-center md:text-left xl:flex-row max-w-[2000px] xl:px-10 min-h-screen justify-center xl:space-y-0 mx-auto items-center">
      ...
      <h3 className="absolute top-36 uppercase tracking-[3px] text-port-purple text-sm">{`Hover over a skill for the number of projects I've created that incorporate it`}</h3>
      <div>
        <Skill />
      </div>
    </motion.div>
